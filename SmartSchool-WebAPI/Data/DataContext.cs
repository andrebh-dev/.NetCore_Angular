        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Marta", "Kent", "32546835"),
                    new Aluno(2, "Paula", "Isabela", "36546545"),
                    new Aluno(3, "Laura", "Antonia", "34825739"),
                    new Aluno(4, "Luiza", "Maria", "35897542"),
                    new Aluno(5, "Lucas", "Machado", "32548795"),
                    new Aluno(6, "Pedro", "Alvares", "34876512"),
                    new Aluno(7, "Paulo", "José", "38975426")
                });
